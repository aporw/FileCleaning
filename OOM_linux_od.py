...
def queryfunction(outfile,logfile,paths):
    ...
    secondpreline = ""
    issuetime = ""
    errors=["java.lang.OutOfMemoryError"]
    ...
    try:
        ...
        for line in out:
            ...
            if (c > 0):
                ...
                query = "insert into OOM (issue_time, filepath) VALUES ('" + timing + "','" + paths2+"\\\\"+out2  +"')"
                print query
...
#    paths5=allpaths[(4*m:n]
    ...
    #print(paths2)
    pwd = os.getcwd()
    serverarray = ['efmserver','efmManagedServer', 'efmManagedServer1', 'efmManagedServer2', 'efmManagedServer3','efmManagedServer4']
